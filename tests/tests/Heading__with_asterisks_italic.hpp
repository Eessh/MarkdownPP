...
void Heading__with_asterisks_italic() {
	...
	Utils::Test test("Heading with italic styling using asterisks", "Checking lexer for parsing level-1 heading with italic styling using asterisks: \"# *Hola, I'm Eessh*\", this should not make heading italic, as heading is an AtomicToken.");
