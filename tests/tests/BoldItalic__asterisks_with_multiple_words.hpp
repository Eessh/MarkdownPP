...
void BoldItalic__asterisks_with_multiple_words() {
	...
	Utils::Test test("Bold and Italic styling using asterisks, with multiple words", "Checking lexer for bold and italic styling using asterisks, with multiple words: ***Hola, I'm Eessh***");
